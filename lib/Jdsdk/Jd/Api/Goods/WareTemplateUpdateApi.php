...
class WareTemplateUpdateApi implements IApi{
     ...
     * @var string
     */
    public $method = '360buy.ware.template.update';
    ...
    /**
     * WareTemplateUpdateApi constructor.
     */
    ...
    {
        header('Location:http://jos.jd.com/api/detail.htm?apiName=360buy.ware.template.update&id=110');
    }
}
