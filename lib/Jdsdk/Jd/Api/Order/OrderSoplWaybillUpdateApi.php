...
class OrderSoplWaybillUpdateApi implements IApi {
     ...
     * @var string
     */
    public $method = '360buy.order.sopl.waybill.update';
    ...
    {
        header('Location:http://jos.jd.com/api/detail.htm?apiName=360buy.order.sopl.waybill.update&id=538');
    }
}