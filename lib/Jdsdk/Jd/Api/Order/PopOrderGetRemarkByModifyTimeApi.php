...
class PopOrderGetRemarkByModifyTimeApi implements IApi{
     ...
     * @var string
     */
    public $method = 'jingdong.pop.order.getRemarkByModifyTime';
    ...
    {
        header('Location:http://jos.jd.com/api/detail.htm?apiName=jingdong.pop.order.getRemarkByModifyTime&id=743');
    }
}
