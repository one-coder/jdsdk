...
class OrderSopWaybillUpdateApi implements IApi {
     ...
     * @var string
     */
    public $method = '360buy.order.sop.waybill.update';
    ...
    {
        header('Location:http://jos.jd.com/api/detail.htm?apiName=360buy.order.sop.waybill.update&id=537');
    }
}